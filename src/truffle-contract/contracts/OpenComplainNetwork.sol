...
contract OpenComplainNetwork {
    ...
    constructor() OpenComplainNetwork() public {
    ...
    function registerComplain(string memory data, uint long, uint lat, uint cat) public payable returns(uint) {
    ...
    function modifyPoliceAccounts(address[] memory accounts) public superuserAccess {
